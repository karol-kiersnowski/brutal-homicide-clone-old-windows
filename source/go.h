...
{
		map_y--;
    	if (map_y <= (screen_h/2)-1) screen_y--;
    	else if (map_y >= (map_h-screen_h/2)-1) screen_y--;
    	else scroll_y--;
}
void go_down()
{
		map_y++;
    	if (map_y <= (screen_h/2)) screen_y++;
    	else if (map_y >= (map_h - screen_h / 2)) screen_y++;
    	else scroll_y++;
}
void go_left()
{
		map_x--;
    	if (map_x <= (screen_w/2)-1) screen_x--;
    	else if (map_x >= (map_w-screen_w/2)-1) screen_x--;
    	else scroll_x--;
}
void go_right()
{
		map_x++;
    	if (map_x <= (screen_w/2)) screen_x++;
    	else if (map_x >= (map_w - screen_w / 2)) screen_x++;
    	else scroll_x++;
}
*/
